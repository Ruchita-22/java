...
//		validationDemo.emailValidation(str);
//		System.out.println("Enter the data");
//		 str=scanner.next();	
//		validationDemo.specialCharacter(str);
//		System.out.println("Enter the data to check length");
//		 str=scanner.next();
//		System.out.println("Enter the length");
//		int length=scanner.nextInt();
//		validationDemo.dataLength(str,length);
//		System.out.println("Enter the day data");
//		 str=scanner.next();
//		String []validValues={"SUNDAY","MONDAY","TUESDAY","WEDNESDAY","THURSDAY","FRIDAY","SATURADAY"};
//		validationDemo.domainValue(str, validValues);
//		System.out.println("Enter the date");
//		 str=scanner.next();
//		System.out.println("Enter the format");
//		String format=scanner.next();
//		validationDemo.formatValidation(str, format);
		
//		System.out.println("Enter the data you need to check");
//		String str=scanner.next();
